...
public class Seckillorder implements Serializable {
     ...
     * @param id 主键
     */
    public Seckillorder setId(Long id) {
        this.id = id;
        return this;
    }
     ...
     */
    public Seckillorder setSeckillId(Long seckillId) {
        this.seckillId = seckillId;
        return this;
    }
     ...
     * @param money 支付金额
     */
    public Seckillorder setMoney(BigDecimal money) {
        this.money = money;
        return this;
    }
     ...
     * @param userId 用户
     */
    public Seckillorder setUserId(String userId) {
        this.userId = userId;
        return this;
    }
     ...
     * @param sellerId 商家
     */
    public Seckillorder setSellerId(String sellerId) {
        this.sellerId = sellerId;
        return this;
    }
     ...
     */
    public Seckillorder setCreateTime(Date createTime) {
        this.createTime = createTime;
        return this;
    }
     ...
     * @param payTime 支付时间
     */
    public Seckillorder setPayTime(Date payTime) {
        this.payTime = payTime;
        return this;
    }
     ...
     * @param status 状态
     */
    public Seckillorder setStatus(String status) {
        this.status = status;
        return this;
    }
     ...
     */
    public Seckillorder setReceiverAddress(String receiverAddress) {
        this.receiverAddress = receiverAddress;
        return this;
    }
     ...
     */
    public Seckillorder setReceiverMobile(String receiverMobile) {
        this.receiverMobile = receiverMobile;
        return this;
    }
     ...
     * @param receiver 收货人
     */
    public Seckillorder setReceiver(String receiver) {
        this.receiver = receiver;
        return this;
    }
     ...
     */
    public Seckillorder setTransactionId(String transactionId) {
        this.transactionId = transactionId;
        return this;
    }
