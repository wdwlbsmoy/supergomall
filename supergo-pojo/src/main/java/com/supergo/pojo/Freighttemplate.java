...
public class Freighttemplate implements Serializable {
     ...
     * @param id
     */
    public Freighttemplate setId(Long id) {
        this.id = id;
        return this;
    }
     ...
     * @param sellerId 商家ID
     */
    public Freighttemplate setSellerId(String sellerId) {
        this.sellerId = sellerId;
        return this;
    }
     ...
     */
    public Freighttemplate setIsDefault(String isDefault) {
        this.isDefault = isDefault;
        return this;
    }
     ...
     * @param name 模版名称
     */
    public Freighttemplate setName(String name) {
        this.name = name;
        return this;
    }
     ...
     */
    public Freighttemplate setSendTimeType(String sendTimeType) {
        this.sendTimeType = sendTimeType;
        return this;
    }
     ...
     * @param price 统一价格
     */
    public Freighttemplate setPrice(Long price) {
        this.price = price;
        return this;
    }
     ...
     */
    public Freighttemplate setCreateTime(Date createTime) {
        this.createTime = createTime;
        return this;
    }
