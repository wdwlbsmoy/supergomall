...
public class Oauthrefreshtoken implements Serializable {
     ...
     * @param tokenId
     */
    public Oauthrefreshtoken setTokenId(String tokenId) {
        this.tokenId = tokenId;
        return this;
    }
     ...
     * @param token
     */
    public Oauthrefreshtoken setToken(byte[] token) {
        this.token = token;
        return this;
    }
     ...
     */
    public Oauthrefreshtoken setAuthentication(byte[] authentication) {
        this.authentication = authentication;
        return this;
    }
