...
public class Typetemplate implements Serializable {
     ...
     * @param id
     */
    public Typetemplate setId(Long id) {
        this.id = id;
        return this;
    }
     ...
     * @param name 模板名称
     */
    public Typetemplate setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @param specIds 关联规格
     */
    public Typetemplate setSpecIds(String specIds) {
        this.specIds = specIds;
        return this;
    }
     ...
     * @param brandIds 关联品牌
     */
    public Typetemplate setBrandIds(String brandIds) {
        this.brandIds = brandIds;
        return this;
    }
     ...
     */
    public Typetemplate setCustomAttributeItems(String customAttributeItems) {
        this.customAttributeItems = customAttributeItems;
        return this;
    }
